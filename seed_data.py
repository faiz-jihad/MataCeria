...
def seed_data():
    ...
    # 2. TAMBAHKAN ARTIKEL EDUKASI MATA (BANYAK TERPERINCI + UNFORMATTED/LONG)
    raw_articles = [
        {
    ...
    # Tambahkan variasi "Unformatif" (Sangat panjang/Raw text) untuk testing UI
    ...
    print(f"{len(all_articles)} Articles seeded (Mixed types).")
